			...
			<div class="col-lg-4">				
				...
				<div class='set-settings card mt-5'>
					<div class="card-body bg-light border">
						<form id="register" method="POST" class="" action="" >
							<!-- Register settings -->
							<h5 class="page-header">Register</h5>
							
							<div class="form-floating mb-3">							
								<input type="text" class="form-control username" value="" />
							...
							<!-- Submit -->
							<div class="mb-3">
								<button type="submit" class="btn btn-success w-100 submit-register" name="submit">Register</button>
							</div>
...
$('#register').on('submit', function (e) {				
	...
	var username = $('.username').val();  // username user
